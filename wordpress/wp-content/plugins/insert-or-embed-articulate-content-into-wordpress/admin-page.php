...
<div class="container">
	...
	<div class="intro">
		...
		<div class="block">
			<h1>Thank you for installing this plugin by <a rel="noopener noreferrer" target=_"blank" href="https://www.elearningfreak.com">elearningfreak.com</a></h1>
		...
		<div class="block">
			...
			<div class="button-wrap wpforms-clear">
				<div class="left">
					<a target=
_blank" href="https://www.elearningfreak.com/upload-articulate-storyline-wordpress/" class="wpforms-btn wpforms-btn-block wpforms-btn-lg wpforms-btn-orange" rel="noopener noreferrer">
						Storyline								</a>
				</div>
				<div class="right">
					<a href="https://www.elearningfreak.com/upload-adobe-captivate-wordpress/" class="wpforms-btn wpforms-btn-block wpforms-btn-lg wpforms-btn-grey" target="_blank" rel="noopener noreferrer">
						Captivate								</a>
				</div>
			...
			<div class="button-wrap wpforms-clear">
				<div class="left">
					<a target=
_blank" href="https://www.elearningfreak.com/upload-ispring-wordpress/" class="wpforms-btn wpforms-btn-block wpforms-btn-lg wpforms-btn-orange" rel="noopener noreferrer">
						iSpring								</a>
				</div>
				<div class="right">
...
<a rel="noopener noreferrer" target="_blank" href="https://www.youtube.com/channel/UCVFSb0lNtWaHEVvBaGyWkZg/videos" class="wpforms-btn wpforms-btn-lg wpforms-btn-orange">
	...
	<div class="features">
		...
		<div class="block">
			...
			<div class="button-wrap">
				<a href="https://www.elearningfreak.com/changelog-release-notes-roadmap/" class="wpforms-btn wpforms-btn-lg wpforms-btn-grey" rel="noopener noreferrer" target="_blank">
	...
	<div class="upgrade-cta upgrade">
		...
		<div class="block wpforms-clear">
			...
			<div class="right">
				...
				<a href="https://www.elearningfreak.com/checkout/?edd_action=add_to_cart&download_id=1032&edd_options%5Bprice_id%5D=5" rel="noopener noreferrer" target="_blank" class="wpforms-btn wpforms-btn-block wpforms-btn-lg wpforms-btn-orange wpforms-upgrade-modal">
					Buy Now							</a>
			</div>
	...
	<div class="footer">
		...
		<div class="block wpforms-clear">
			...
			<div class="button-wrap wpforms-clear">
				...
				<div class="right">
					<a href="https://www.elearningfreak.com/checkout/?edd_action=add_to_cart&download_id=1032&edd_options%5Bprice_id%5D=5" target="_blank" rel="noopener noreferrer" class="wpforms-btn wpforms-btn-block wpforms-btn-lg wpforms-btn-trans-green wpforms-upgrade-modal">
