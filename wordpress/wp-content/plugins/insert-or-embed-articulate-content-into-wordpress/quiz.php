...
const PLUGINVERSION   = '43000000017';
...
if ( ! function_exists( 'quiz_embeder_register_plugin_links' ) ) {
	function quiz_embeder_register_plugin_links( $links, $file ) {
		...
		if ( $file == $base ) {
			...
			$links[] = '<a href="https://www.elearningfreak.com/checkout/?edd_action=add_to_cart&download_id=1032&edd_options%5Bprice_id%5D=5">' . __( 'Upgrade to Premium', 'insert-or-embed-articulate-content-into-wordpress' ) . '</a>';
